...
def _prepare_nvcc_cli(opts):
    ## cmd = 'nvcc ' + opts.strip(), referencing https://stackoverflow.com/questions/59342888/tensorflow-error-this-file-requires-compiler-and-library-support-for-the-iso-c
